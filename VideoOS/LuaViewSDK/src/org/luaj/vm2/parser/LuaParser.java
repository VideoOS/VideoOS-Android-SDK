...
public class LuaParser implements LuaParserConstants {
    ...
    static Exp.VarExp assertvarexp(Exp.PrimaryExp pe) throws ParseException {
        if (!pe.isvarexp())
            throw new ParseException("expected variable");
        return (Exp.VarExp) pe;
    }

    static Exp.FuncCall assertfunccall(Exp.PrimaryExp pe) throws ParseException {
        if (!pe.isfunccall())
...
//  }remove by yanqiu
    ...
    void L(SyntaxElement e, long startinfo) {
    ...
    void L(SyntaxElement e, Token starttoken) {
     ...
     * Root production.
     */
    public Chunk Chunk() throws ParseException {
        Block b;
        Chunk c;
        long i = LineInfo();
    ...
    public Stat Stat() throws ParseException {
        Block b, b2;
        Exp e, e2, e3 = null;
        Stat s;
        FuncName fn;
    ...
    public Stat IfThenElse() throws ParseException {
        Block b, b2, b3 = null;
        Exp e, e2;
        List<Exp> el = null;
        List<Block> bl = null;
    ...
    public Stat ReturnStat() throws ParseException {
        List<Exp> el = null;
        Stat s;
        long i = LineInfo();
    ...
    public Stat Label() throws ParseException {
        Token n;
    ...
    public Stat ExprStat() throws ParseException {
        Exp.PrimaryExp p;
        Stat s = null;
        long i = LineInfo();
        p = PrimaryExp();
    ...
    public Stat Assign(Exp.VarExp v0) throws ParseException {
    ...
    public Exp.VarExp VarExp() throws ParseException {
        Exp.PrimaryExp p;
        p = PrimaryExp();
        {
    ...
    public FuncName FuncName() throws ParseException {
        Token n;
        FuncName f;
        n = jj_consume_token(NAME);
    ...
    public Exp.PrimaryExp PrefixExp() throws ParseException {
        Token n;
        Exp e;
        Exp.PrimaryExp p;
        long i = LineInfo();
    ...
    public Exp.PrimaryExp PrimaryExp() throws ParseException {
        Exp.PrimaryExp p;
        long i = LineInfo();
        p = PrefixExp();
        label_5:
    ...
    public Exp.PrimaryExp PostfixOp(Exp.PrimaryExp lhs) throws ParseException {
        Token n;
        Exp e;
        FuncArgs a;
        Exp.PrimaryExp p;
    ...
    public FuncArgs FuncArgs() throws ParseException {
        List<Exp> el = null;
        TableConstructor tc;
        LuaString s;
        FuncArgs a;
    ...
    public List<Name> NameList() throws ParseException {
    ...
    public List<Exp> ExpList() throws ParseException {
    ...
    public Exp SimpleExp() throws ParseException {
        Token n;
        LuaString s;
        Exp e;
        TableConstructor c;
    ...
    public LuaString Str() throws ParseException {
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case STRING:
    ...
    public Exp Exp() throws ParseException {
        Exp e, s;
        int op;
        long i = LineInfo();
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
    ...
    public FuncBody FunctionCall() throws ParseException {
        FuncBody b;
        long i = LineInfo();
        jj_consume_token(FUNCTION);
        b = FuncBody();
    ...
    public FuncBody FuncBody() throws ParseException {
        ParList pl = null;
        Block b;
        FuncBody f;
        long i = LineInfo();
    ...
    public ParList ParList() throws ParseException {
        List<Name> l = null;
        boolean v = false;
        ParList p;
        long i = LineInfo();
    ...
    public TableConstructor TableConstructor() throws ParseException {
    ...
    public List<TableField> FieldList() throws ParseException {
    ...
    public TableField Field() throws ParseException {
        Token name;
        Exp exp, rhs;
        TableField f;
        long i = LineInfo();
    ...
    public void FieldSep() throws ParseException {
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case 72:
                jj_consume_token(72);
                break;
    ...
    JJCalls[] jj_2_rtns = new JJCalls[7];
...
//    }remove by yanqiu
    ...
    LookaheadSuccess jj_ls = new LookaheadSuccess();
...
//    }remove by yanqiu
    ...
    List jj_expentries = new ArrayList();
    int[] jj_expentry;
    int jj_kind = -1;
