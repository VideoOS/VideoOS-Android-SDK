...
import cn.com.venvy.lua.maper.VenvyActivityLifeCycleMapper;
...
public class VenvyActivityLifeCycleBinder extends BaseFunctionBinder {

    public VenvyActivityLifeCycleBinder() {
        super("Page");
    }
    ...
    public LuaValue createCreator(LuaValue env, LuaValue metaTable) {
        return new BaseVarArgUICreator(env.checkglobals(), metaTable, getMapperClass()) {
            ...
            public ILVView createView(Globals globals, LuaValue metaTable, Varargs varargs) {
                return new VenvyLVActivityCallback(globals, metaTable, varargs);
            }
        };
    }
