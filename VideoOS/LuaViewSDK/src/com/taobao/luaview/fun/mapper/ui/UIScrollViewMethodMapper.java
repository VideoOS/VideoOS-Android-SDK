...
public class UIScrollViewMethodMapper<U extends UDScrollView> extends UIViewGroupMethodMapper<U> {

    private static final String TAG = "UIScrollViewMethodMapper";
    ...
    public Varargs setOrientation(U view, Varargs varargs) {
        if (varargs.narg() > 1) {
            Integer integer = LuaUtil.getInt(varargs, 2);
            if (integer != null) {
                return view.setOrientation(integer);
            }
        }
