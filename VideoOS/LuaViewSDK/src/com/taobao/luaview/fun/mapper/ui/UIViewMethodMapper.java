...
public class UIViewMethodMapper<U extends UDView> extends BaseMethodMapper<U> {
    static String TAG = "UIViewMethodMapper";
    ...
    public LuaValue setTag(U view, Varargs varargs) {
        String tag = LuaUtil.getString(varargs, 2);
