...
public class StandardVideoOSPlayer extends GSYVideoPlayer {
...
//    protected String mAppkey = "0be7a880-39a1-11e9-9805-7f36f371c764";
//    protected String mAppSecret = "2d700de7c548";

    /**
     * 1.5.0开始加入，如果需要不同布局区分功能，需要重载
     */
    public StandardVideoOSPlayer(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public StandardVideoOSPlayer(Context context) {
        super(context);
    }

    public StandardVideoOSPlayer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void init(Context context) {
        ...
        if (mNextButton == null) {
            mNextButton = findViewById(R.id.player_next);
        }
        //增加自定义ui
    ...
    public int getLayoutId() {
        return R.layout.video_os_layout_standard;
    }
    ...
    public void startPlayLogic() {
        if (mVideoAllCallBack != null) {
            ...
            mVideoAllCallBack.onClickStartThumb(mOriginUrl, mTitle, StandardVideoOSPlayer.this);
        }
        prepareVideo();
    ...
    protected void cloneParams(GSYBaseVideoPlayer from, GSYBaseVideoPlayer to) {
        ...
        StandardVideoOSPlayer sf = (StandardVideoOSPlayer) from;
        StandardVideoOSPlayer st = (StandardVideoOSPlayer) to;
