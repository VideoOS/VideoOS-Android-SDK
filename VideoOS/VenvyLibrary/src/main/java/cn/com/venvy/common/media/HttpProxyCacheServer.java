package cn.com.venvy.common.media;
...
import cn.com.venvy.common.media.file.TotalCountLruDiskUsage;
import cn.com.venvy.common.media.file.TotalSizeLruDiskUsage;
import cn.com.venvy.common.media.headers.EmptyHeadersInjector;
import cn.com.venvy.common.media.headers.HeaderInjector;
import cn.com.venvy.common.media.sourcestorage.SourceInfoStorage;
import cn.com.venvy.common.media.sourcestorage.SourceInfoStorageFactory;
import cn.com.venvy.common.utils.VenvyLog;

import static cn.com.venvy.common.media.Preconditions.checkAllNotNull;
import static cn.com.venvy.common.media.Preconditions.checkNotNull;
...
public class HttpProxyCacheServer {
    ...
    private HttpProxyCacheServer(Config config) {
        ...
        try {
            ...
            VenvyLog.i("Proxy cache server started. Is it alive? " + isAlive());
    ...
    public void registerCacheListener(CacheListener cacheListener, String url) {
        ...
        synchronized (clientsLock) {
            try {
                ...
                VenvyLog.w("Error registering cache listener", e);
            }
        }
    }
    ...
    public void shutdown() {
        VenvyLog.i("Shutdown proxy server");
    ...
    private void touchFileSafely(File cacheFile) {
        try {
            ...
            VenvyLog.e("Error touching file " + cacheFile, e);
        }
    }
    ...
    private void waitForRequest() {
        try {
            while (!Thread.currentThread().isInterrupted()) {
                ...
                VenvyLog.d("Accept new socket " + socket);
    ...
    private void processSocket(Socket socket) {
        try {
            ...
            VenvyLog.d("Closing socket… Socket is closed by client.");
        } catch (ProxyCacheException | IOException e) {
            onError(new ProxyCacheException("Error processing request", e));
        } finally {
            releaseSocket(socket);
            VenvyLog.d("Opened connections: " + getClientsCount());
        }
    }
    ...
    private void closeSocketInput(Socket socket) {
        try {
            ...
            // There is no way to determine that client closed connection http://stackoverflow.com/a/10241044/999458
            // So just to prevent log flooding don't log stacktrace
            VenvyLog.d("Releasing input stream… Socket is closed by client.");
        } catch (IOException e) {
    ...
    private void onError(Throwable e) {
        VenvyLog.e("HttpProxyCacheServer error", e);
    }
