 ...
 * cn.com.asmp.widget
 */
public class AppKeyPopup extends BasePopupWindow {
    private AppKeyConfigAdapter mConfigAdapter;

    public AppKeyPopup(Context context) {
        super(context);
    ...
    public View onCreateContentView() {
        ...
        mConfigAdapter = new AppKeyConfigAdapter(null);
    ...
    public AppKeyConfigAdapter getAdapter() {
